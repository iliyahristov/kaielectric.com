...
class ControllerMailRegister extends Controller {
	public function index(&$route, &$args, &$output) {
		...
		$data['title'] = $this->language->get('text_thanks');
        ...
        $data['text_thanks_for_registration'] = sprintf($this->language->get('text_thanks_for_registration'), $args[0]['firstname']);
        $data['text_explanation'] 	= $this->config->get('text_explanation');//text_explanation sentence
        $data['store_contact_page'] = $this->url->link('information/contact','', true);
