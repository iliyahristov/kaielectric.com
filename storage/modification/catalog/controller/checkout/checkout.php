...
class ControllerCheckoutCheckout extends Controller {
 ...
 $this->response->setOutput(json_encode($json)); 
	...
	public function index() {
				...
				// TK Checkout
				if($this->config->get('module_tk_checkout_token') && $this->config->get('module_tk_checkout_status')){
					return new Action('tk_checkout/checkout');
				}
				// TK Checkout
 ...
 if ($information_info) { 
 $data['text_privacy'] = sprintf($this->language->get('text_agree'), $this->url->link('information/information/agree', 'information_id='. $this->config->get('config_account_id'), true), $information_info['title'],
