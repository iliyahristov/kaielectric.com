...
class ControllerCommonLogin extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            if ($this->config->get('module_tfa_status') && $this->config->get('module_tfa_for_admin') && (!isset($this->session->data['user_id']) || $this->session->data['user_id'] == 0 && isset($this->session->data['tfa_user_id']) && $this->session->data['tfa_user_id'] > 0)) {
