...
class ControllerCommonColumnLeft extends Controller {
 ...
 'children' => $magentech
			...
			if ($this->user->hasPermission('access', 'sale/order')) {
				...
				if($this->config->get('module_tk_checkout_token')){
					if ($this->user->hasPermission('access', 'sale/tk_abandoned_cart')) {
						$sale[] = array(
							'name'	 => $this->language->get('text_abandoned_cart'),
							'href' => $this->url->link('sale/tk_abandoned_cart', 'user_token=' . $this->session->data['user_token'], true),
							'children' => array()
						);
					}
				}
 ...
 'children' => $simpleblog
			...
			//data upload
			$data_upload = array();
			//related products data upload
			if ($this->user->hasPermission('access', 'data/related_products_upload')) {
				$data_upload[] = array(
					'name'	   => 'Данни за свързани продукти',
					'href'     => $this->url->link('data/related_products_upload', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			//related products data upload
			if ($this->user->hasPermission('access', 'data/related_module_name')) {
				$data_upload[] = array(
					'name'	   => 'Название модул свързани продукти',
					'href'     => $this->url->link('data/related_module_name', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			//product data data
			if ($this->user->hasPermission('access', 'data/data_upload')) {
				$data_upload[] = array(
					'name'	   => $this->language->get('text_data_upload'),
					'href'     => $this->url->link('data/data_upload', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			
			//product promo data
			if ($this->user->hasPermission('access', 'data/promo_upload')) {
				$data_upload[] = array(
					'name'	   => "Промоции",
					'href'     => $this->url->link('data/promo_upload', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			//product picture
			if ($this->user->hasPermission('access', 'data/picture_upload')) {
				$data_upload[] = array(
					'name'	   => $this->language->get('text_picture_upload'),
					'href'     => $this->url->link('data/picture_upload', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			//product specif
			if ($this->user->hasPermission('access', 'data/specif_upload')) {
				$data_upload[] = array(
					'name'	   => $this->language->get('text_specif_upload'),
					'href'     => $this->url->link('data/specif_upload', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			//product filters
			if ($this->user->hasPermission('access', 'data/filters_upload')) {
				$data_upload[] = array(
					'name'	   => $this->language->get('text_filters_upload'),
					'href'     => $this->url->link('data/filters_upload', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			if ($this->user->hasPermission('access', 'data/vtac_picture_upload')) {
				$data_upload[] = array(
					'name'	   => $this->language->get('text_vtac_picture_upload'),
					'href'     => $this->url->link('data/vtac_picture_upload', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
