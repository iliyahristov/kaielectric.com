...
class __TwigTemplate_4631a66d222d281e8acbd8c14571250b0d583f6351ecc1cdc48f127032fe5940 extends Twig_Template
{
...
/*           <div class="form-group{% if custom_field.required %} required {% endif %} custom-field" data-sort="{{ custom_field.sort_order }}">*/
/*             <label class="col-sm-6 control-label">{{ custom_field.name }}</label>*/
/*             <div class="col-sm-6" style="text-align: left;">*/
