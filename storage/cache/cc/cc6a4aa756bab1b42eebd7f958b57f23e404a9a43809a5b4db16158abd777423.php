...
/* so-revo/template/soconfig/listing.twig */
class __TwigTemplate_c7d35478fd532289afc7bb1f2158ec0b23bb3e113ccc238be0ee0e7ec5ae5c8f extends Twig_Template
{
...
\t\t\t\t\t\t<option value=\"";
            // line 40
            echo $this->getAttribute($context["sorts"], "value", array());
            echo "\">";
...
\t\t\t\t\t\t";
                // line 106
                $this->loadTemplate(((isset($context["theme_directory"]) ? $context["theme_directory"] : null) . "/template/soconfig/countdown.twig"), "so-revo/template/soconfig/listing.twig", 106)->display(array_merge($context, array("product" => $context["product"], "special_end_date" => $this->getAttribute($context["product"], "special_end_date", array()))));
                // line 107
                echo "\t\t\t\t\t
\t\t\t\t\t";
            }
...
";
    ...
    {
        return "so-revo/template/soconfig/listing.twig";
    }
